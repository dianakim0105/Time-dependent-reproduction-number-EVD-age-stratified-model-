...
We have started from comparing learned score field vs true score field. A linear score network was expressive enough for a single Gaussian as the true noisy score is linear.The score diagnostics indicated that the model was learning the score reasonably well. 
